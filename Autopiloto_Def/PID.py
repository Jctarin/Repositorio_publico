...
class PID(object):
    ...
    def __call__(self, input_, dt=None):
        ...
        d_input = error - (self._last_input if self._last_input is not None else error)
        ...
        output = self.Kp*self._proportional + (self._integral + self.Ki*error*dt) + self.Kd*self._derivative
        output_saturated = _clamp(output, self.output_limits)
